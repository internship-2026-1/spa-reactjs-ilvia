      ...
      <header className="dashboard-navbar">
        ...
        <div className="dashboard-navbar__left">
          ...
          <nav className="dashboard-navbar__links">
            <a href="/" className="active">Sistemas</a>
          ...
          <table className="inventory-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span className="tag blue">GPU</span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <span className="tag purple">CPU</span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <span className="tag gray-tag">RAM</span>
                </td>
